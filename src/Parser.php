...
namespace pointybeard\ReverseRegex;

use pointybeard\ReverseRegex\Exception as ParserException;
...
class Parser
{
    ...
    /**
     * @var pointybeard\ReverseRegex\Generator\Scope
     */
    protected $result;

    /**
     * @var pointybeard\ReverseRegex\Generator\Scope the current head
     */
    protected $head;

    /**
     * @var pointybeard\ReverseRegex\Generator\Scope Last attached scope
     */
    protected $left;
    ...
    public static $sub_parsers = [
        'character' => '\\pointybeard\\ReverseRegex\\Parser\\CharacterClass',
        'unicode' => '\\pointybeard\\ReverseRegex\\Parser\\Unicode',
        'quantifer' => '\\pointybeard\\ReverseRegex\\Parser\\Quantifier',
        'short' => '\\pointybeard\\ReverseRegex\\Parser\\Short',
    ];
