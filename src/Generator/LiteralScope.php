...
use pointybeard\ReverseRegex\ArrayCollection;
use pointybeard\ReverseRegex\Exception as GeneratorException;
...
{
    /**
     * @var pointybeard\ReverseRegex\ArrayCollection container for literals values
     */
    protected $literals;
